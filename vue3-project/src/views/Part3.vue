...
const handleExport = async (type) => {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/app/part3/export/`, {
      method: 'POST',
      headers: {
    ...
    let filename = `店铺销量分析_${new Date().getTime()}`
