        ...
        <div class="filter-export-section">
          <div class="row align-items-center mb-3">
            ...
            <div class="col-auto">
              ...
              >
                <el-option label="横向柱状图" value="bar" />
...
const chartType = ref('bar') // 默认横向柱状图
...
const handleExport = async (type) => {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/app/part7/export/`, {
      method: 'POST',
      headers: {
    ...
    let filename = `商品平均价格分析_${new Date().getTime()}`
